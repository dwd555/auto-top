...
def main(file,port,xls,arg):#file:读取的日志文件；port：选择atom还是arm,或者只查看单独一个程序；xls：选择保存的路径；arg：需要查看的top信息
	...
	writeData(Process, log,index,True,sheet1)
	workbook.save(xls)
	print("保存excel文件成功")
#运行
main("d:/192.168.1.202_05-07 00;00;00.log","t.ngod.core",'d:/atom.xls',"VSZ")